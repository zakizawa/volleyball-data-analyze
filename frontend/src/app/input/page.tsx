...
//   const totalSpike = players.reduce(
//     (spikeSum: number, p: PlayerRow): number => {
...
//                     onChange={(e) => {
//                       const copy = [...players];
//                       copy[i].position = e.target
//                         .value as PlayerRow['position'];
//                       setPlayers(copy);
//                     }}
